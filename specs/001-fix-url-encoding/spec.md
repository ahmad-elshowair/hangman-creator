# Feature Specification: URL-Safe Shareable Links

**Feature Branch**: `001-fix-url-encoding`  
**Created**: 2026-03-30  
**Status**: Draft  
**Input**: User description: "Fix shareable links breaking via Base64URL encoding. Do NOT add an expiration date."
...
- **FR-002**: System MUST parse incoming configurations from the URL Hash fragments resiliently.
...
- **SC-001**: Shared URLs contain strictly alphanumeric characters and hyphens/underscores in the `config=` hash fragment.
- **SC-002**: 100% of links shared via WhatsApp and Slack render successfully without returning "no configs" (null).
